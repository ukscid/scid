...
proc configure_style {} {
  ...
  set fg [ttk::style lookup . -foreground "" "#808080"]
  set bg [ttk::style lookup . -background "" grey10]
  set sb [ttk::style lookup . -selectbackground  "" "#808080"]
  # rectangle toggleswitch 
  image create bitmap ::switch(on) -foreground $sg -background $bg -data {
  ...
  image create bitmap ::switch(off) -foreground $fg -background $bg -data {
      ...
      static unsigned char switchoff_bits[] = {
          0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, 0x80, 0x01, 0x00,
          0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00,
          0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9,
          0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00,
          0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80,
          0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f, 0x00, 0x00, 0x80, 0xf9, 0x7f,
          0x00, 0x00, 0x80, 0x01, 0x00, 0x00, 0x00, 0x80, 0x01, 0x00, 0x00, 0x00,
          0x80, 0xff, 0xff, 0xff, 0xff, 0xff };
  }
  # circle toggleswitch 
  image create bitmap ::switch(on) -foreground $sb -background $bg -data {
      #define rson18_width 36
      #define rson18_height 18
      static unsigned char rson18_bits[] = {
          0x80, 0xff, 0xff, 0x1f, 0x00, 0x60, 0x00, 0x00, 0x60, 0x00, 0x18, 0x00,
          0x00, 0x80, 0x01, 0x04, 0x00, 0x00, 0x0c, 0x02, 0x04, 0x00, 0x80, 0x7f,
          0x02, 0x02, 0x00, 0xc0, 0xff, 0x04, 0x02, 0x00, 0xc0, 0xff, 0x04, 0x01,
          0x00, 0xc0, 0xff, 0x08, 0x01, 0x00, 0xe0, 0xff, 0x09, 0x01, 0x00, 0xe0,
          0xff, 0x09, 0x01, 0x00, 0xc0, 0xff, 0x08, 0x02, 0x00, 0xc0, 0xff, 0x04,
          0x02, 0x00, 0xc0, 0xff, 0x04, 0x04, 0x00, 0x80, 0x7f, 0x02, 0x04, 0x00,
          0x00, 0x0c, 0x02, 0x18, 0x00, 0x00, 0x80, 0x01, 0x60, 0x00, 0x00, 0x60,
          0x00, 0x80, 0xff, 0xff, 0x1f, 0x00 };
  }
  image create bitmap ::switch(off) -foreground $fg -background $bg -data {
      #define rsoff18_width 36
      #define rsoff18_height 18
      static unsigned char rsoff18_bits[] = {
          0x80, 0xff, 0xff, 0x1f, 0x00, 0x60, 0x00, 0x00, 0x60, 0x00, 0x18, 0x00,
          0x00, 0x80, 0x01, 0x04, 0x03, 0x00, 0x00, 0x02, 0xe4, 0x1f, 0x00, 0x00,
          0x02, 0xf2, 0x3f, 0x00, 0x00, 0x04, 0xf2, 0x3f, 0x00, 0x00, 0x04, 0xf1,
          0x3f, 0x00, 0x00, 0x08, 0xf9, 0x7f, 0x00, 0x00, 0x08, 0xf9, 0x7f, 0x00,
          0x00, 0x08, 0xf1, 0x3f, 0x00, 0x00, 0x08, 0xf2, 0x3f, 0x00, 0x00, 0x04,
          0xf2, 0x3f, 0x00, 0x00, 0x04, 0xe4, 0x1f, 0x00, 0x00, 0x02, 0x04, 0x03,
          0x00, 0x00, 0x02, 0x18, 0x00, 0x00, 0x80, 0x01, 0x60, 0x00, 0x00, 0x60,
          0x00, 0x80, 0xff, 0xff, 0x1f, 0x00 };
  }
